...
import json
def easyCheck(s):
    return "CreateDirectionalMarginGeometry" in s
def scoreForDict(d):
    import sys
...
def argumentsRight(d):
    args = ["Examination","SourceRoiName","Beam","Direction","DistalDistance","ProximalDistance","LateralDistance"]
    too_many = []
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "CreateDirectionalMarginGeometry")
