...
import json
def easyCheck(s):
    return "CreateMarginGeometry" in s
def scoreForDict(d):
    import sys
...
def argumentsRight(d):
    args = ["Examination","SourceRoiName","MarginSettings"]
    too_many = []
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "CreateMarginGeometry")
