...
def get_info():
    return json.loads("{\"base\": \"Plan.BeamSets.[].DependentApprovedStructureSet.ApprovedPoiStructures.[].OfPoi\", \"params\": [\"Material\"], \"method\": \"SetRoiMaterial\", \"description\": \"SetRoiMaterial(..)\\r\\n  Assigns a new material to this ROI. The material density will \\r\\n  override the ROI density for dose computation on all image sets.\\r\\n  Parameters:\\r\\n    Material - The new material.\\r\\n\"}")
