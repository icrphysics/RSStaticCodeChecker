...
import json
def easyCheck(s):
    return "CreatePlanExploration" in s
def scoreForDict(d):
    import sys
...
def argumentsRight(d):
    args = ["Name","ExaminationName","Description","PlannedBy"]
    too_many = []
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "CreatePlanExploration")
