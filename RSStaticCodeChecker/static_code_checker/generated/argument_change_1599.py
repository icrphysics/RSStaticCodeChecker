...
import json
def easyCheck(s):
    return "CreateDefaultIsocenterData" in s
def scoreForDict(d):
    import sys
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "CreateDefaultIsocenterData")
...
def get_info():
    return json.loads("{\"base\": \"Case.TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource\", \"params\": [\"Position\"], \"method\": \"CreateDefaultIsocenterData\", \"description\": \"CreateDefaultIsocenterData(..)\\r\\n  Returns default IsocenterData for a position.\\r\\n  Parameters:\\r\\n    Position - Isocenter position.\\r\\n\"}")
