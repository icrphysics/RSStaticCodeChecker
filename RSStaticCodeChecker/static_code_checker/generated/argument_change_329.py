...
import json
def easyCheck(s):
    return "CreateCylinderGeometry" in s
def scoreForDict(d):
    import sys
...
def argumentsRight(d):
    args = ["Radius","Axis","Length","Examination","Center","VoxelSize"]
    too_many = []
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "CreateCylinderGeometry")
