...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "GetIsocenterData")
...
def get_info():
    return json.loads("{\"base\": \"Case.TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource\", \"params\": [\"Name\"], \"method\": \"GetIsocenterData\", \"description\": \"GetIsocenterData(..)\\r\\n  Returns IsocenterData for an existing isocenter.\\r\\n  Parameters:\\r\\n    Name - Name of isocenter.\\r\\n\"}")
