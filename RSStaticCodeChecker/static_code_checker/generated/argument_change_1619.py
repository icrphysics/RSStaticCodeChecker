...
import json
def easyCheck(s):
    return "EditShowBeamVisualization" in s
def scoreForDict(d):
    import sys
...
def argumentsRight(d):
    args = ["ShowBeams","ShowContour","ShowCenterLine","ShowBeamsFromAllBeamSets","ShowIsocenterNames"]
    too_many = []
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "EditShowBeamVisualization")
