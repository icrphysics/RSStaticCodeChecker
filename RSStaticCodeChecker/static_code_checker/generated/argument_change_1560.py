...
import json
def easyCheck(s):
    return "DeleteDoseSpecificationPoint" in s
def scoreForDict(d):
    import sys
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "DeleteDoseSpecificationPoint")
...
def get_info():
    return json.loads("{\"base\": \"Case.TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource\", \"params\": [\"Name\"], \"method\": \"DeleteDoseSpecificationPoint\", \"description\": \"DeleteDoseSpecificationPoint(..)\\r\\n  Action that deletes a dose specification point.\\r\\n  Parameters:\\r\\n    Name - Name of the dose specification point to delete.\\r\\n\"}")
