...
def get_info():
    return json.loads("{\"base\": \"BeamSet.DrrSettings.[].BeamListSource.FractionDose.BeamDoses.[].OnDensity.RoiListSource\", \"params\": [\"Examination\", \"RoiNames\", \"CustomStatistics\", \"CustomSettings\"], \"method\": \"AdaptMbsMeshes\", \"description\": \"AdaptMbsMeshes(..)\\r\\n  Adapts MBS meshes to the specified examination.\\r\\n  Parameters:\\r\\n    Examination - The examination.\\r\\n    RoiNames - The ROI names.\\r\\n    CustomStatistics - Lookup table for custom image region \\r\\n      statistics per ROI.\\r\\n    CustomSettings - Lookup table for custom settings per ROI.\\r\\n\"}")
