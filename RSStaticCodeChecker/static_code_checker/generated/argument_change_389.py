...
import json
def easyCheck(s):
    return "SetDoseSpecificationPoint" in s
def scoreForDict(d):
    import sys
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "SetDoseSpecificationPoint")
...
def get_info():
    return json.loads("{\"base\": \"Patient.Cases.[].TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource.PatientSetup.SetupBeams.[]\", \"params\": [\"Name\"], \"method\": \"SetDoseSpecificationPoint\", \"description\": \"SetDoseSpecificationPoint(..)\\r\\n  Select a dose specification point for this beam.\\r\\n  Parameters:\\r\\n    Name - The name of an existing dose specification point, \\r\\n      or \\\"Isocenter\\\" to use isocenter.\\r\\n\"}")
