...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "GetBEVImage")
...
def get_info():
    return json.loads("{\"base\": \"Patient.Cases.[].TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource.PatientSetup.SetupBeams.[]\", \"params\": [\"ShowFluence\"], \"method\": \"GetBEVImage\", \"description\": \"GetBEVImage(..)\\r\\n  Method for retrieving BEV image for a beam.\\r\\n  Parameters:\\r\\n    ShowFluence - Show fluence or not.\\r\\n  Returns:\\r\\n    Filename for the created image.\\r\\n\"}")
