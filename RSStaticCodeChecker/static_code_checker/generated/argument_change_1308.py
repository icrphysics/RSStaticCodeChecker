...
def dictMatchScore_0(d):
    ...
    if score_temp == sys.maxint:
        ...
        score += score_temp
    steps += 1
    score_temp = lib.score_generic(d.get("value").get("value"), "ApprovedRoiStructures")
    if score_temp == sys.maxint:
        return sys.maxint
    else:
        score += score_temp
    ...
    if score_temp == sys.maxint:
        ...
        score += score_temp
    steps += 1
    score_temp = lib.score_generic(d.get("value").get("value").get("value").get("value"), "ApprovedStructureSets")
    if score_temp == sys.maxint:
        return sys.maxint
    else:
        score += score_temp
    ...
    if score_temp == sys.maxint:
        ...
        score += score_temp
    steps += 1
    score_temp = score_Case.get_score(d.get("value").get("value").get("value").get("value").get("value").get("value").get("value").get("value"))
    if score_temp == sys.maxint:
        return sys.maxint
    else:
        score += score_temp
