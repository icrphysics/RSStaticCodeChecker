...
def argumentsRight(d):
    args = ["MaximumStepLength","UseFixedFirstSpot","PreferredDirection","OfflinePenaltyFactor"]
    too_many = []
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "SortSpots")
