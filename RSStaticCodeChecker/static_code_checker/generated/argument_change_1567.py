...
def argumentsRight(d):
    args = ["ArcStopGantryAngle","ArcRotationDirection","Energy","IsocenterData","Name","Description","GantryAngle","CouchAngle","CollimatorAngle"]
    too_many = []
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "CreateArcBeam")
