...
def get_info():
    return json.loads("{\"base\": \"Patient.Cases.[].TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource\", \"params\": [\"TreatmentMachineName\"], \"method\": \"MachineFeasibilityTest\", \"description\": \"MachineFeasibilityTest(..)\\r\\n  Returns string with information regarding if machine can be \\r\\n  changed to 'TreatmentMachineName'. The string is empty if the \\r\\n  change is feasible.\\r\\n  Parameters:\\r\\n    TreatmentMachineName - Name of treatment machine\\r\\n\"}")
