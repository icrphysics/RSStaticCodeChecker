...
def get_info():
    return json.loads("{\"base\": \"BeamSet.DrrSettings.[].BeamListSource.FractionDose.BeamDoses.[].OnDensity.OutlineSource\", \"params\": [\"RoiNames\", \"RemoveHoles3D\", \"RemoveSmallContours\", \"AreaThreshold\", \"ReduceMaxNumberOfPointsInContours\", \"MaxNumberOfPoints\", \"CreateCopyOfRoi\"], \"method\": \"SimplifyContours\", \"description\": \"SimplifyContours(..)\\r\\n  Action for simplifying contours.\\r\\n  Parameters:\\r\\n    RoiNames - List of ROI names.\\r\\n    RemoveHoles3D - Remove holes in 3D.\\r\\n    RemoveSmallContours - Remove small contours.\\r\\n    AreaThreshold - Area threshold [cm^2].\\r\\n    ReduceMaxNumberOfPointsInContours - Reduce the number of \\r\\n      points in contours.\\r\\n    MaxNumberOfPoints - Max number of points.\\r\\n    CreateCopyOfRoi - Create copy of ROI.\\r\\n\"}")
