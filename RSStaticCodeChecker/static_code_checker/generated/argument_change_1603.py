...
import json
def easyCheck(s):
    return "CreateDoseSpecificationPoint" in s
def scoreForDict(d):
    import sys
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "CreateDoseSpecificationPoint")
...
def get_info():
    return json.loads("{\"base\": \"Case.TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource\", \"params\": [\"Name\", \"Coordinates\"], \"method\": \"CreateDoseSpecificationPoint\", \"description\": \"CreateDoseSpecificationPoint(..)\\r\\n  Action that creates a dose specification point.\\r\\n  Parameters:\\r\\n    Name - The name of the dose specification point.\\r\\n    Coordinates - The coordinates of the dose specification \\r\\n      point [cm].\\r\\n\"}")
