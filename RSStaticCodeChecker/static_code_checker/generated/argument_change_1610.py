...
def get_info():
    return json.loads("{\"base\": \"Case.TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource.PatientSetup.SetupBeams.[]\", \"params\": [\"Name\"], \"method\": \"SetDoseSpecificationPoint\", \"description\": \"SetDoseSpecificationPoint(..)\\r\\n  Select a dose specification point for this beam.\\r\\n  Parameters:\\r\\n    Name - The name of an existing dose specification point, \\r\\n      or \\\"Isocenter\\\" to use isocenter.\\r\\n\"}")
