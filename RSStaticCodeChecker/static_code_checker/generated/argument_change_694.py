...
def argumentsRight(d):
    args = ["SourceExamination","TargetExaminationNames","RoiNames"]
    too_many = []
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "CopyRoiGeometries")
...
def get_info():
    return json.loads("{\"base\": \"Plan.BeamSets.[].DrrSettings.[].BeamListSource.FractionDose.BeamDoses.[].OnDensity.RoiListSource\", \"params\": [\"SourceExamination\", \"TargetExaminationNames\", \"RoiNames\"], \"method\": \"CopyRoiGeometries\", \"description\": \"CopyRoiGeometries(..)\\r\\n  Copies RoiGeometries between structure sets.\\r\\n  Parameters:\\r\\n    SourceExamination - The source examination.\\r\\n    TargetExaminationNames - List of target examination names.\\r\\n    RoiNames - List of ROI names.\\r\\n\"}")
