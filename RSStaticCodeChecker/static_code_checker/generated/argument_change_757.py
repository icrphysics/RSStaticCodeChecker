...
def get_info():
    return json.loads("{\"base\": \"Plan.BeamSets.[].DrrSettings.[].BeamListSource.PatientSetup.SetupBeams.[]\", \"params\": [\"NameOfTemplate\"], \"method\": \"SetArcTrajectoryFromTemplate\", \"description\": \"SetArcTrajectoryFromTemplate(..)\\r\\n  Sets the arc trajectory on a beam from a template.\\r\\n  Example:\\r\\n    \\r\\n  beam_set.Beams[0].SetArcTrajectoryFromTemplate(NameOfTemplate=\\\"L5 \\r\\n  lung\\\")\\r\\n  Parameters:\\r\\n    NameOfTemplate - Name of Wave Arc Template to set to beam.\\r\\n\"}")
