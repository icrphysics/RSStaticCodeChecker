...
def get_info():
    return json.loads("{\"base\": \"BeamSet.DrrSettings.[].BeamListSource.FractionDose.BeamDoses.[].OnDensity.DensityOverrides.[].RoiGeometry.OfRoi\", \"params\": [\"Examination\", \"SourceRoiName\", \"OutwardDistance\", \"InwardDistance\"], \"method\": \"CreateWallGeometry\", \"description\": \"CreateWallGeometry(..)\\r\\n  Creates a wall geometry.\\r\\n  Parameters:\\r\\n    Examination - The examination.\\r\\n    SourceRoiName - The name of the source region of interest.\\r\\n    OutwardDistance - The outward distance, must be positive \\r\\n      and less than 5 cm.\\r\\n    InwardDistance - The inward distance, must be positive and \\r\\n      less than 5 cm.\\r\\n\"}")
