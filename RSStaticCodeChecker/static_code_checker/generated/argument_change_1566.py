...
import json
def easyCheck(s):
    return "ReadOnlyPathChecking" in s
def scoreForDict(d):
    import sys
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "ReadOnlyPathChecking")
