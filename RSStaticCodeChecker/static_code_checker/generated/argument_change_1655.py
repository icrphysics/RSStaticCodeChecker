...
def argumentsRight(d):
    args = ["PlanName","PlannedBy","Comment","ExaminationName","AllowDuplicateNames"]
    too_many = []
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "AddNewPlan")
