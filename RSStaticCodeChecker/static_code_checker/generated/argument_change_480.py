...
import json
def easyCheck(s):
    return "AddOptimizationFunction" in s
def scoreForDict(d):
    import sys
...
def argumentsRight(d):
    args = ["FunctionType","RoiName","IsConstraint","RestrictAllBeamsIndividually","RestrictToBeam","IsRobust","RestrictToBeamSet","UseRbeDose"]
    too_many = []
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "AddOptimizationFunction")
