...
import json
def easyCheck(s):
    return "CreateControllingRoiGeometry" in s
def scoreForDict(d):
    import sys
...
def argumentsRight(d):
    args = ["ReferenceExaminationName","TargetExaminationNames","RoiGeometryName","SmoothingRadius"]
    too_many = []
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "CreateControllingRoiGeometry")
