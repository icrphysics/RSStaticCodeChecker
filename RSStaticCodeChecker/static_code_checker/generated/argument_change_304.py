...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "GetDoseStatistic")
...
def get_info():
    return json.loads("{\"base\": \"Patient.Cases.[].TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource.FractionDose.BeamDoses.[]\", \"params\": [\"RoiName\", \"DoseType\"], \"method\": \"GetDoseStatistic\", \"description\": \"GetDoseStatistic(..)\\r\\n  Method for retrieving dose statistics\\r\\n  Parameters:\\r\\n    RoiName - The name of the ROI.\\r\\n    DoseType - The dose statistic type, \\\"Average\\\", \\\"Min\\\" or \\r\\n      \\\"Max\\\".\\r\\n  Returns:\\r\\n    The dose statistic.\\r\\n\"}")
