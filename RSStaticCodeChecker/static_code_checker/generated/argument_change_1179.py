...
def get_info():
    return json.loads("{\"base\": \"PatientDB.TemplatePatientModels.[].PatientModel\", \"params\": [\"SourceExamination\", \"TargetExamination\", \"RoiName\"], \"method\": \"CopyRoiGeometry\", \"description\": \"CopyRoiGeometry(..)\\r\\n  Copies an RoiGeometry from a source structure set to a target \\r\\n  structure set.\\r\\n  Parameters:\\r\\n    SourceExamination - The source examination.\\r\\n    TargetExamination - The target examination.\\r\\n    RoiName - The ROI name.\\r\\n\"}")
