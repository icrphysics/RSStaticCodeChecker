...
def get_info():
    return json.loads("{\"base\": \"Plan.BeamSets.[].DrrSettings.[].BeamListSource.FractionDose.BeamDoses.[]\", \"params\": [\"RoiName\", \"DoseType\"], \"method\": \"GetDoseStatistic\", \"description\": \"GetDoseStatistic(..)\\r\\n  Method for retrieving dose statistics\\r\\n  Parameters:\\r\\n    RoiName - The name of the ROI.\\r\\n    DoseType - The dose statistic type, \\\"Average\\\", \\\"Min\\\" or \\r\\n      \\\"Max\\\".\\r\\n  Returns:\\r\\n    The dose statistic.\\r\\n\"}")
