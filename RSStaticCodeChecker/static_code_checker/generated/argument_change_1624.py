...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "GetArcTrajectory")
...
def get_info():
    return json.loads("{\"base\": \"Case.TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource\", \"params\": [\"BeamName\"], \"method\": \"GetArcTrajectory\", \"description\": \"GetArcTrajectory(..)\\r\\n  Returns the arc trajectory of the beam.\\r\\n  Parameters:\\r\\n    BeamName - Name of the beam\\r\\n  Returns:\\r\\n    The arc trajectory\\r\\n\"}")
