...
import json
def easyCheck(s):
    return "CopyBeamsFromBeamSet" in s
def scoreForDict(d):
    import sys
...
def argumentsRight(d):
    args = ["BeamSetToCopyFrom","BeamsToCopy"]
    too_many = []
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "CopyBeamsFromBeamSet")
