...
def get_info():
    return json.loads("{\"base\": \"Plan.PlanOptimizations.[].TreatmentCourseSource.BiologyEvaluation\", \"params\": [\"FunctionToRemove\"], \"method\": \"DeleteClinicalGoal\", \"description\": \"DeleteClinicalGoal(..)\\r\\n  Deletes a clinical goal.\\r\\n  Parameters:\\r\\n    FunctionToRemove - The clinical goal that shall be removed.\\r\\n\"}")
