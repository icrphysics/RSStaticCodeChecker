...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "SetBeamIsVisible")
...
def get_info():
    return json.loads("{\"base\": \"Case.TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource\", \"params\": [\"BeamName\", \"IsVisible\"], \"method\": \"SetBeamIsVisible\", \"description\": \"SetBeamIsVisible(..)\\r\\n  Setting if beam is visible or not.\\r\\n  Parameters:\\r\\n    BeamName - The name of the beam in beam set.\\r\\n    IsVisible - True if beam is visible.\\r\\n\"}")
