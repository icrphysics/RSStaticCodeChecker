...
def get_info():
    return json.loads("{\"base\": \"Patient.Cases.[].TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource.FractionDose\", \"params\": [\"RoiName\"], \"method\": \"GetDoseGridRoi\", \"description\": \"GetDoseGridRoi(..)\\r\\n  Gets the dose grid representation of a specific ROI for the dose \\r\\n  grid of the dose distribution.\\r\\n  Parameters:\\r\\n    RoiName - The name of the ROI.\\r\\n  Returns:\\r\\n    The dose grid representation of the ROI.\\r\\n\"}")
