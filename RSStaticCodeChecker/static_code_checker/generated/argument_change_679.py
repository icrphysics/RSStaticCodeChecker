...
import json
def easyCheck(s):
    return "SetRoiGeometryRepresentationToTriangleMesh" in s
def scoreForDict(d):
    import sys
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "SetRoiGeometryRepresentationToTriangleMesh")
...
def get_info():
    return json.loads("{\"base\": \"Plan.BeamSets.[].DrrSettings.[].BeamListSource.FractionDose.BeamDoses.[].OnDensity.OutlineSource\", \"params\": [\"ROI\", \"Indices\", \"Vertices\"], \"method\": \"SetRoiGeometryRepresentationToTriangleMesh\", \"description\": \"SetRoiGeometryRepresentationToTriangleMesh(..)\\r\\n  Set the ROI geometry to a triangle mesh.\\r\\n  This method is for experimental use - use with care.\\r\\n  Parameters:\\r\\n    ROI - Name of the ROI that the triangle mesh shall be \\r\\n      assigned to.\\r\\n    Indices - Array with triangle mesh indices.\\r\\n    Vertices - Array with triangle mesh vertices.\\r\\n\"}")
