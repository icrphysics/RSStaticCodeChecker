...
import json
def easyCheck(s):
    return "CopyRoiGeometryToAnotherROI" in s
def scoreForDict(d):
    import sys
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "CopyRoiGeometryToAnotherROI")
...
def get_info():
    return json.loads("{\"base\": \"Plan.BeamSets.[].DrrSettings.[].BeamListSource.FractionDose.BeamDoses.[].OnDensity.OutlineSource\", \"params\": [\"FromROI\", \"ToROI\"], \"method\": \"CopyRoiGeometryToAnotherROI\", \"description\": \"CopyRoiGeometryToAnotherROI(..)\\r\\n  Copy the ROI geometry of an ROI to another ROI.\\r\\n  This method is for experimental use - use with care.\\r\\n  Parameters:\\r\\n    FromROI - Name of the ROI with the geometry to copy.\\r\\n    ToROI - Name of the ROI the geometry shall be copied to.\\r\\n\"}")
