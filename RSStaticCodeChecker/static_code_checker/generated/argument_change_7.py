...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "CopyPlan")
...
def get_info():
    return json.loads("{\"base\": \"Patient.Cases.[]\", \"params\": [\"PlanName\", \"NewPlanName\"], \"method\": \"CopyPlan\", \"description\": \"CopyPlan(..)\\r\\n  Copies a treatment plan.\\r\\n  Parameters:\\r\\n    PlanName - Name of the plan to copy.\\r\\n    NewPlanName - Desired name of the new plan.\\r\\n\"}")
