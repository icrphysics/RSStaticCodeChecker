...
import json
def easyCheck(s):
    return "MachineFeasibilityTest" in s
def scoreForDict(d):
    import sys
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "MachineFeasibilityTest")
...
def get_info():
    return json.loads("{\"base\": \"Case.TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource\", \"params\": [\"TreatmentMachineName\"], \"method\": \"MachineFeasibilityTest\", \"description\": \"MachineFeasibilityTest(..)\\r\\n  Returns string with information regarding if machine can be \\r\\n  changed to 'TreatmentMachineName'. The string is empty if the \\r\\n  change is feasible.\\r\\n  Parameters:\\r\\n    TreatmentMachineName - Name of treatment machine\\r\\n\"}")
