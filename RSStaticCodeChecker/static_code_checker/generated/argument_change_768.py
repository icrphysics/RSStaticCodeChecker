...
def get_info():
    return json.loads("{\"base\": \"Plan.BeamSets.[].DrrSettings.[].BeamListSource\", \"params\": [\"OutputFormat\", \"TargetDirectory\", \"FileName\"], \"method\": \"PatientMarkingExport\", \"description\": \"PatientMarkingExport(..)\\r\\n  Export patient marking\\r\\n  Parameters:\\r\\n    OutputFormat - Output format.\\r\\n      Supported formats:\\r\\n      LAP File format 1.0\\r\\n    TargetDirectory - Directory to store result to\\r\\n    FileName - File name\\r\\n\"}")
