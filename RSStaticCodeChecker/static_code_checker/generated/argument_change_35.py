...
def get_info():
    return json.loads("{\"base\": \"Patient.Cases.[].TreatmentDelivery.TreatmentCourse.TotalDose\", \"params\": [\"RoiName\", \"RelativeVolumes\"], \"method\": \"GetDoseAtRelativeVolumes\", \"description\": \"GetDoseAtRelativeVolumes(..)\\r\\n  Method for retrieving DVH points.\\r\\n  Parameters:\\r\\n    RoiName - The name of the ROI.\\r\\n    RelativeVolumes - The relative volumes.\\r\\n  Returns:\\r\\n    The dose at the relative volumes.\\r\\n\"}")
