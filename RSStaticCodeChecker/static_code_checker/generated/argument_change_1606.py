...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "CopyBeam")
...
def get_info():
    return json.loads("{\"base\": \"Case.TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource\", \"params\": [\"BeamName\"], \"method\": \"CopyBeam\", \"description\": \"CopyBeam(..)\\r\\n  Creates a copy of the specified beam and appends the copy to the \\r\\n  beam list.\\r\\n  Parameters:\\r\\n    BeamName - The name of the beam that shall be copied.\\r\\n\"}")
