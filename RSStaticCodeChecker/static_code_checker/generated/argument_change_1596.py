...
import json
def easyCheck(s):
    return "AutoBreastAddRoisAndBeams" in s
def scoreForDict(d):
    import sys
...
def argumentsRight(d):
    args = ["NominalEnergy","HighNominalEnergy","SUPName","INFName","MEDName","LATName","ANTName","SeparationThreshold"]
    too_many = []
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "AutoBreastAddRoisAndBeams")
