...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "SetBeamNP")
...
def get_info():
    return json.loads("{\"base\": \"Patient.Cases.[].TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource.PatientSetup.SetupBeams.[]\", \"params\": [\"NumberOfParticles\"], \"method\": \"SetBeamNP\", \"description\": \"SetBeamNP(..)\\r\\n  Method for setting the ion beam meterset in units of Number of \\r\\n  Particles\\r\\n  Parameters:\\r\\n    NumberOfParticles - The number of particles to set for the \\r\\n      ion beam.\\r\\n\"}")
