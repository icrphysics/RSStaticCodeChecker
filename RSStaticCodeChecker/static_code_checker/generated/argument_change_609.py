...
def get_info():
    return json.loads("{\"base\": \"Plan.BeamSets.[].DrrSettings.[].BeamListSource.FractionDose.BeamDoses.[]\", \"params\": [\"DoseGrid\"], \"method\": \"GetTransformedAndResampledDoseValues\", \"description\": \"GetTransformedAndResampledDoseValues(..)\\r\\n  Resamples the dose distribution to the given dose grid.\\r\\n  Parameters:\\r\\n    DoseGrid - The dose grid on which the dose shall be \\r\\n      resampled.\\r\\n  Returns:\\r\\n    An array containing the resampled dose values.\\r\\n\"}")
