...
def get_info():
    return json.loads("{\"base\": \"Patient.Cases.[].TreatmentPlans.[].PlanOptimizations.[].TreatmentCourseSource.EvaluationSetup\", \"params\": [\"Template\"], \"method\": \"ApplyClinicalGoalTemplate\", \"description\": \"ApplyClinicalGoalTemplate(..)\\r\\n  Copies clinical goals from a template.\\r\\n  Parameters:\\r\\n    Template - The template that contains the functions. \\r\\n      Functions corresponding to ROIs/POIs\\r\\n      that are not contained in the patient model will not be added.\\r\\n\"}")
