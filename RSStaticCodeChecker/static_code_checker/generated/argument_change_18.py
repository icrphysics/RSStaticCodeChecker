...
import json
def easyCheck(s):
    return "CopyMultipleExplorationPlansToPlanList" in s
def scoreForDict(d):
    import sys
...
def argumentsRight(d):
    args = ["PlanExplorationName","ExplorationPlanNames"]
    too_many = []
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "CopyMultipleExplorationPlansToPlanList")
