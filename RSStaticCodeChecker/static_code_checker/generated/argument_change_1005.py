...
def get_info():
    return json.loads("{\"base\": \"BeamSet.DrrSettings.[].BeamListSource.FractionDose.BeamDoses.[].OnDensity.RoiListSource\", \"params\": [\"Examination\", \"SUPName\", \"INFName\", \"MEDName\", \"LATName\", \"ANTName\", \"ExternalName\"], \"method\": \"DetectBreastMarkers\", \"description\": \"DetectBreastMarkers(..)\\r\\n  For auto breast planning only.\\r\\n  Detect the SUP, INF, MED, LAT and ANT markers, and create external \\r\\n  ROI.\\r\\n  Parameters:\\r\\n    Examination - The name of the examination.\\r\\n    SUPName - Superior POI.\\r\\n    INFName - Inferior POI.\\r\\n    MEDName - Medial POI.\\r\\n    LATName - Lateral POI.\\r\\n    ANTName - Anterior POI.\\r\\n    ExternalName - External ROI.\\r\\n\"}")
