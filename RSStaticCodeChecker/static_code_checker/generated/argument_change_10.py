...
import json
def easyCheck(s):
    return "CopyMultiplePlansToExploration" in s
def scoreForDict(d):
    import sys
...
def argumentsRight(d):
    args = ["PlanExplorationName","TreatmentPlanNames"]
    too_many = []
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "CopyMultiplePlansToExploration")
