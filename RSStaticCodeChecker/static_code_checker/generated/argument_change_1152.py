...
def get_info():
    return json.loads("{\"base\": \"PatientDB.TemplatePatientModels.[].PatientModel\", \"params\": [\"SourceExamination\", \"TargetExaminationNames\", \"RoiNames\"], \"method\": \"CopyRoiGeometries\", \"description\": \"CopyRoiGeometries(..)\\r\\n  Copies RoiGeometries between structure sets.\\r\\n  Parameters:\\r\\n    SourceExamination - The source examination.\\r\\n    TargetExaminationNames - List of target examination names.\\r\\n    RoiNames - List of ROI names.\\r\\n\"}")
