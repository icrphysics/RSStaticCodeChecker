...
import json
def easyCheck(s):
    return "GetDoseAtRelativeVolumesForAccumulatedDeliveredDose" in s
def scoreForDict(d):
    import sys
...
def argumentsRight(d):
    args = ["FromFractionNumber","ToFractionNumber","RoiName","RelativeVolumes"]
    too_many = []
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "GetDoseAtRelativeVolumesForAccumulatedDeliveredDose")
