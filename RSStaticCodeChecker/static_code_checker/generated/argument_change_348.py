...
def get_info():
    return json.loads("{\"base\": \"Patient.Cases.[].TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource\", \"params\": [\"Name\"], \"method\": \"GetIsocenterData\", \"description\": \"GetIsocenterData(..)\\r\\n  Returns IsocenterData for an existing isocenter.\\r\\n  Parameters:\\r\\n    Name - Name of isocenter.\\r\\n\"}")
