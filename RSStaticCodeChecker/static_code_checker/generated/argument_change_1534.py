...
def get_info():
    return json.loads("{\"base\": \"Case.TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource.FractionDose.BeamDoses.[].OnDensity.DensityOverrides.[].RoiGeometry.OfRoi\", \"params\": [\"Examination\", \"ThresholdLevel\"], \"method\": \"CreateExternalGeometry\", \"description\": \"CreateExternalGeometry(..)\\r\\n  Creates an external geometry for the ROI on the specified \\r\\n  examination.\\r\\n  Parameters:\\r\\n    Examination - The examination.\\r\\n    ThresholdLevel - The threshold level that determines the \\r\\n      outline. Set to None in order to automatically calculate \\r\\n      threshold value.\\r\\n\"}")
