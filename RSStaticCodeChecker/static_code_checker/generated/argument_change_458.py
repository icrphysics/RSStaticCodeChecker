...
def get_info():
    return json.loads("{\"base\": \"Plan.PlanOptimizations.[].TreatmentCourseSource.TotalDose\", \"params\": [\"RoiName\", \"DoseValues\"], \"method\": \"GetRelativeVolumeAtDoseValues\", \"description\": \"GetRelativeVolumeAtDoseValues(..)\\r\\n  Method for retrieving DVH points.\\r\\n  Parameters:\\r\\n    RoiName - The name of the ROI.\\r\\n    DoseValues - The dose values in cGy.\\r\\n  Returns:\\r\\n    The relative volumes at the dose values.\\r\\n\"}")
