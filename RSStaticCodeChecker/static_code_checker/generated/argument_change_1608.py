...
def get_info():
    return json.loads("{\"base\": \"Case.TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource.PatientSetup.SetupBeams.[]\", \"params\": [\"X1\", \"X2\", \"Y1\", \"Y2\"], \"method\": \"SetInitialJawPositions\", \"description\": \"SetInitialJawPositions(..)\\r\\n  Sets initial jaw positions to the beam.\\r\\n  Parameters:\\r\\n    X1 - X1 - Left jaw.\\r\\n    X2 - X2 - Right jaw.\\r\\n    Y1 - Y1 - Top jaw.\\r\\n    Y2 - Y2 - Bottom jaw.\\r\\n\"}")
