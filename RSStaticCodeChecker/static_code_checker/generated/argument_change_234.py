...
import json
def easyCheck(s):
    return "UnsetBeamSetsToOptimizeSimultaneously" in s
def scoreForDict(d):
    import sys
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "UnsetBeamSetsToOptimizeSimultaneously")
...
def get_info():
    return json.loads("{\"base\": \"Patient.Cases.[].TreatmentPlans.[]\", \"params\": [\"BeamSetNames\"], \"method\": \"UnsetBeamSetsToOptimizeSimultaneously\", \"description\": \"UnsetBeamSetsToOptimizeSimultaneously(..)\\r\\n  Sets beam sets that were set to be optimized simultaneously to \\r\\n  be optimized separately\\r\\n  Parameters:\\r\\n    BeamSetNames - The name of the beam sets sat should be \\r\\n      optimized separately\\r\\n\"}")
