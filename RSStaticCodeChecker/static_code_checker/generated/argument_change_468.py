...
def get_info():
    return json.loads("{\"base\": \"Plan.PlanOptimizations.[].TreatmentCourseSource.BiologyEvaluation\", \"params\": [\"FunctionToCopy\"], \"method\": \"CopyClinicalGoal\", \"description\": \"CopyClinicalGoal(..)\\r\\n  Copy of a clinical goal.\\r\\n  Parameters:\\r\\n    FunctionToCopy - The clinical goal that shall be copied.\\r\\n\"}")
