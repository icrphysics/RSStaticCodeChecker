...
import json
def easyCheck(s):
    return "CopyBeamFromBeamSet" in s
def scoreForDict(d):
    import sys
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "CopyBeamFromBeamSet")
...
def get_info():
    return json.loads("{\"base\": \"Case.TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource\", \"params\": [\"BeamToCopy\", \"ResetBeamMu\"], \"method\": \"CopyBeamFromBeamSet\", \"description\": \"CopyBeamFromBeamSet(..)\\r\\n   Copy beam from beam set.\\r\\n  Parameters:\\r\\n    BeamToCopy - The beam that shall be copied.\\r\\n    ResetBeamMu - Reset Beam MU to zero.\\r\\n\"}")
