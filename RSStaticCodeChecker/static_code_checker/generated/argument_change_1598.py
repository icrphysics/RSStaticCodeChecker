...
def argumentsRight(d):
    args = ["Beam","Contour","Type","LeafPositioningPolicy"]
    too_many = []
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "AddVirtualBlock")
