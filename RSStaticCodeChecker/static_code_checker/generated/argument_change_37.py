...
def get_info():
    return json.loads("{\"base\": \"Patient.Cases.[].TreatmentDelivery.TreatmentCourse.EvaluationSetup\", \"params\": [\"FunctionToRemove\"], \"method\": \"DeleteClinicalGoal\", \"description\": \"DeleteClinicalGoal(..)\\r\\n  Deletes a clinical goal.\\r\\n  Parameters:\\r\\n    FunctionToRemove - The clinical goal that shall be removed.\\r\\n\"}")
