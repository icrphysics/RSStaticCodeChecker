...
def get_info():
    return json.loads("{\"base\": \"Case.TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource.FractionDose.BeamDoses.[].OnDensity.DensityOverrides.[].RoiGeometry.OfRoi\", \"params\": [\"Examination\", \"CustomStatistics\", \"CustomSettings\"], \"method\": \"AdaptMbsMesh\", \"description\": \"AdaptMbsMesh(..)\\r\\n  Adapts an MBS mesh to the specified examination.\\r\\n  Parameters:\\r\\n    Examination - The examination.\\r\\n    CustomStatistics - Custom graylevel statistics.\\r\\n    CustomSettings - Custom MBS settings.\\r\\n\"}")
