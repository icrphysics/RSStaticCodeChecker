...
def argumentsRight(d):
    args = ["SourceExamination","TargetExamination","RoiName"]
    too_many = []
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "CopyRoiGeometry")
...
def get_info():
    return json.loads("{\"base\": \"Plan.BeamSets.[].DrrSettings.[].BeamListSource.FractionDose.BeamDoses.[].OnDensity.RoiListSource\", \"params\": [\"SourceExamination\", \"TargetExamination\", \"RoiName\"], \"method\": \"CopyRoiGeometry\", \"description\": \"CopyRoiGeometry(..)\\r\\n  Copies an RoiGeometry from a source structure set to a target \\r\\n  structure set.\\r\\n  Parameters:\\r\\n    SourceExamination - The source examination.\\r\\n    TargetExamination - The target examination.\\r\\n    RoiName - The ROI name.\\r\\n\"}")
