...
def get_info():
    return json.loads("{\"base\": \"Plan.BeamSets.[].DrrSettings.[].BeamListSource.FractionDose.BeamDoses.[].OnDensity.FromExamination.Series.[].ImageStack\", \"params\": [\"DoseGrid\"], \"method\": \"GetResampledPixelData\", \"description\": \"GetResampledPixelData(..)\\r\\n  Gets the pixel data of the image stack resampled on a dose grid.\\r\\n  Parameters:\\r\\n    DoseGrid - The dose grid used for the resampling.\\r\\n  Returns:\\r\\n    \\r\\n\"}")
