...
def get_info():
    return json.loads("{\"base\": \"Patient.Cases.[].TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource.FractionDose.BeamDoses.[]\", \"params\": [\"Point\"], \"method\": \"InterpolateDoseInPoint\", \"description\": \"InterpolateDoseInPoint(..)\\r\\n  Returns interpolated dosevalue in point.\\r\\n  Parameters:\\r\\n    Point - The coordinates of the point in which the dose is \\r\\n      interpolated. The point's coordinates are given in the DICOM \\r\\n      coordinate system.\\r\\n  Returns:\\r\\n    The interpolated point dose.\\r\\n\"}")
