...
def get_info():
    return json.loads("{\"base\": \"Patient.Cases.[].TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource\", \"params\": [\"Name\"], \"method\": \"DeleteDoseSpecificationPoint\", \"description\": \"DeleteDoseSpecificationPoint(..)\\r\\n  Action that deletes a dose specification point.\\r\\n  Parameters:\\r\\n    Name - Name of the dose specification point to delete.\\r\\n\"}")
