...
import json
def easyCheck(s):
    return "SetDefaultDoseGrid" in s
def scoreForDict(d):
    import sys
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "SetDefaultDoseGrid")
