...
def get_info():
    return json.loads("{\"base\": \"Plan.BeamSets.[].DrrSettings.[].BeamListSource\", \"params\": [\"Position\"], \"method\": \"CreateDefaultIsocenterData\", \"description\": \"CreateDefaultIsocenterData(..)\\r\\n  Returns default IsocenterData for a position.\\r\\n  Parameters:\\r\\n    Position - Isocenter position.\\r\\n\"}")
