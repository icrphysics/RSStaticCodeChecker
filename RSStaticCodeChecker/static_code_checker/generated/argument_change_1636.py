...
def get_info():
    return json.loads("{\"base\": \"Case.TreatmentPlans.[].BeamSets.[]\", \"params\": [\"Name\", \"Coordinates\"], \"method\": \"CreateDoseSpecificationPoint\", \"description\": \"CreateDoseSpecificationPoint(..)\\r\\n  Action that creates a dose specification point.\\r\\n  Parameters:\\r\\n    Name - The name of the dose specification point.\\r\\n    Coordinates - The coordinates of the dose specification \\r\\n      point [cm].\\r\\n\"}")
