...
def get_info():
    return json.loads("{\"base\": \"Plan.PlanOptimizations.[].TreatmentCourseSource.EvaluationSetup\", \"params\": [\"FunctionToRemove\"], \"method\": \"DeleteClinicalGoal\", \"description\": \"DeleteClinicalGoal(..)\\r\\n  Deletes a clinical goal.\\r\\n  Parameters:\\r\\n    FunctionToRemove - The clinical goal that shall be removed.\\r\\n\"}")
