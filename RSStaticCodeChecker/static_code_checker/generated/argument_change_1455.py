...
def get_info():
    return json.loads("{\"base\": \"Case.TreatmentPlans.[]\", \"params\": [\"BeamSetNames\"], \"method\": \"UnsetBeamSetsToOptimizeSimultaneously\", \"description\": \"UnsetBeamSetsToOptimizeSimultaneously(..)\\r\\n  Sets beam sets that were set to be optimized simultaneously to \\r\\n  be optimized separately\\r\\n  Parameters:\\r\\n    BeamSetNames - The name of the beam sets sat should be \\r\\n      optimized separately\\r\\n\"}")
