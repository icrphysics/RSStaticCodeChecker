...
def get_info():
    return json.loads("{\"base\": \"Case.TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource.PatientSetup.SetupBeams.[]\", \"params\": [\"SegmentNumber\"], \"method\": \"DeleteSegment\", \"description\": \"DeleteSegment(..)\\r\\n  Deletes a segment.\\r\\n  Parameters:\\r\\n    SegmentNumber - The number of the segment that shall be \\r\\n      deleted.\\r\\n\"}")
