...
def get_info():
    return json.loads("{\"base\": \"Patient.Cases.[].TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource\", \"params\": [\"Technique\"], \"method\": \"SetTreatmentTechnique\", \"description\": \"SetTreatmentTechnique(..)\\r\\n  Sets treatment technique for a beam set.\\r\\n  Parameters:\\r\\n    Technique - Treatment technique type.\\r\\n\"}")
