...
def get_info():
    return json.loads("{\"base\": \"Patient.Cases.[].TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource.PatientSetup.SetupBeams.[]\", \"params\": [\"BolusName\"], \"method\": \"SetBolus\", \"description\": \"SetBolus(..)\\r\\n  Sets the bolus with name BolusName on this photon beam. Returns \\r\\n  the beam.\\r\\n  Parameters:\\r\\n    BolusName - Name of the bolus.\\r\\n\"}")
