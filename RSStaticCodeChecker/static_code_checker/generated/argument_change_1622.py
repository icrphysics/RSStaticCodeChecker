...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "DeleteBeam")
...
def get_info():
    return json.loads("{\"base\": \"Case.TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource\", \"params\": [\"BeamName\"], \"method\": \"DeleteBeam\", \"description\": \"DeleteBeam(..)\\r\\n  Deletes a beam from the beam list.\\r\\n  Parameters:\\r\\n    BeamName - The name of the beam that shall be deleted.\\r\\n\"}")
