...
def get_info():
    return json.loads("{\"base\": \"Case.TreatmentPlans.[]\", \"params\": [\"BeamSetNames\"], \"method\": \"SetBeamSetsToOptimizeSimultaneously\", \"description\": \"SetBeamSetsToOptimizeSimultaneously(..)\\r\\n  Sets beam sets to be optimized simultaneously\\r\\n  Parameters:\\r\\n    BeamSetNames - The name of the beam sets that should be \\r\\n      optimized simultaneously\\r\\n\"}")
