...
def get_info():
    return json.loads("{\"base\": \"Patient.Cases.[].TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource\", \"params\": [\"BeamName\", \"IsVisible\"], \"method\": \"SetBeamIsVisible\", \"description\": \"SetBeamIsVisible(..)\\r\\n  Setting if beam is visible or not.\\r\\n  Parameters:\\r\\n    BeamName - The name of the beam in beam set.\\r\\n    IsVisible - True if beam is visible.\\r\\n\"}")
