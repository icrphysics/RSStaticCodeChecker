...
import json
def easyCheck(s):
    return "SetReportViewPositions" in s
def scoreForDict(d):
    import sys
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "SetReportViewPositions")
...
def get_info():
    return json.loads("{\"base\": \"Patient.Cases.[].TreatmentPlans.[]\", \"params\": [\"Coordinates\"], \"method\": \"SetReportViewPositions\", \"description\": \"SetReportViewPositions(..)\\r\\n  Action that creates a dose specification point.\\r\\n  Parameters:\\r\\n    Coordinates - The coordinates of the dose specification \\r\\n      point [cm].\\r\\n\"}")
