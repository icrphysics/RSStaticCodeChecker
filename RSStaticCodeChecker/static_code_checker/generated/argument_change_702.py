...
def argumentsRight(d):
    args = ["PatientModelTemplate","Examination"]
    too_many = []
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "AutoBreastAtlas")
...
def get_info():
    return json.loads("{\"base\": \"Plan.BeamSets.[].DrrSettings.[].BeamListSource.FractionDose.BeamDoses.[].OnDensity.RoiListSource\", \"params\": [\"PatientModelTemplate\", \"Examination\"], \"method\": \"AutoBreastAtlas\", \"description\": \"AutoBreastAtlas(..)\\r\\n  For auto breast planning only.\\r\\n  Create aHEART, aRTLUNG, aLTLUNG from a structure template atlas, \\r\\n  unless they already exist.\\r\\n  Parameters:\\r\\n    PatientModelTemplate - Name of the atlas for lung and heart.\\r\\n    Examination - Name of the examination.\\r\\n\"}")
