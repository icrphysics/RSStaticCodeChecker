...
import json
def easyCheck(s):
    return "SetBeamSetsToOptimizeSimultaneously" in s
def scoreForDict(d):
    import sys
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "SetBeamSetsToOptimizeSimultaneously")
...
def get_info():
    return json.loads("{\"base\": \"Patient.Cases.[].TreatmentPlans.[]\", \"params\": [\"BeamSetNames\"], \"method\": \"SetBeamSetsToOptimizeSimultaneously\", \"description\": \"SetBeamSetsToOptimizeSimultaneously(..)\\r\\n  Sets beam sets to be optimized simultaneously\\r\\n  Parameters:\\r\\n    BeamSetNames - The name of the beam sets that should be \\r\\n      optimized simultaneously\\r\\n\"}")
