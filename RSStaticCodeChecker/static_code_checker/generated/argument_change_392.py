...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "DeleteSegment")
...
def get_info():
    return json.loads("{\"base\": \"Patient.Cases.[].TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource.PatientSetup.SetupBeams.[]\", \"params\": [\"SegmentNumber\"], \"method\": \"DeleteSegment\", \"description\": \"DeleteSegment(..)\\r\\n  Deletes a segment.\\r\\n  Parameters:\\r\\n    SegmentNumber - The number of the segment that shall be \\r\\n      deleted.\\r\\n\"}")
