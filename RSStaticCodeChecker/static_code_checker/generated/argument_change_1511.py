...
import json
def easyCheck(s):
    return "SetTreatmentTechnique" in s
def scoreForDict(d):
    import sys
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "SetTreatmentTechnique")
...
def get_info():
    return json.loads("{\"base\": \"Case.TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource\", \"params\": [\"Technique\"], \"method\": \"SetTreatmentTechnique\", \"description\": \"SetTreatmentTechnique(..)\\r\\n  Sets treatment technique for a beam set.\\r\\n  Parameters:\\r\\n    Technique - Treatment technique type.\\r\\n\"}")
