...
def get_info():
    return json.loads("{\"base\": \"Plan.BeamSets.[].DrrSettings.[].BeamListSource.FractionDose.BeamDoses.[].OnDensity.DensityOverrides.[].RoiGeometry.OfRoi\", \"params\": [\"ExaminationName\"], \"method\": \"CreateFieldOfViewROI\", \"description\": \"CreateFieldOfViewROI(..)\\r\\n  Creates field-of-view ROI on a CBCT or CT image\\r\\n  Parameters:\\r\\n    ExaminationName - The name of the examination on which a \\r\\n      field-of-view ROI geometry will be created.\\r\\n\"}")
