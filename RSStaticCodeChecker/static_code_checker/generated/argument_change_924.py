...
def get_info():
    return json.loads("{\"base\": \"BeamSet.DrrSettings.[].BeamListSource.FractionDose.BeamDoses.[].OnDensity.FromExamination\", \"params\": [\"TransformationMatrix\", \"CenterOfRotation\"], \"method\": \"GetAffineTransformationParametersGivenCenterOfRotation\", \"description\": \"GetAffineTransformationParametersGivenCenterOfRotation(..)\\r\\n  Method for extracting registration parameters in elastix \\r\\n  AffineTransformation format.\\r\\n  Parameters:\\r\\n    TransformationMatrix - \\r\\n    CenterOfRotation - \\r\\n\"}")
