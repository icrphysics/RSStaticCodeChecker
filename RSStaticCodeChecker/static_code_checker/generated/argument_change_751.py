...
def get_info():
    return json.loads("{\"base\": \"Plan.BeamSets.[].DrrSettings.[].BeamListSource\", \"params\": [\"BeamToCopy\", \"ResetBeamMu\"], \"method\": \"CopyBeamFromBeamSet\", \"description\": \"CopyBeamFromBeamSet(..)\\r\\n   Copy beam from beam set.\\r\\n  Parameters:\\r\\n    BeamToCopy - The beam that shall be copied.\\r\\n    ResetBeamMu - Reset Beam MU to zero.\\r\\n\"}")
