...
import json
def easyCheck(s):
    return "GetDoseAtRelativeVolumes" in s
def scoreForDict(d):
    import sys
...
def dictMatchScore_0(d):
    ...
    steps += 1
    score_temp = lib.score_generic(d, "GetDoseAtRelativeVolumes")
...
def get_info():
    return json.loads("{\"base\": \"Patient.Cases.[].TreatmentPlans.[].BeamSets.[].DrrSettings.[].BeamListSource.FractionDose.BeamDoses.[]\", \"params\": [\"RoiName\", \"RelativeVolumes\"], \"method\": \"GetDoseAtRelativeVolumes\", \"description\": \"GetDoseAtRelativeVolumes(..)\\r\\n  Method for retrieving DVH points.\\r\\n  Parameters:\\r\\n    RoiName - The name of the ROI.\\r\\n    RelativeVolumes - The relative volumes.\\r\\n  Returns:\\r\\n    The dose at the relative volumes.\\r\\n\"}")
