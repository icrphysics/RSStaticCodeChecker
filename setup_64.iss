...
Source: "RSStaticCodeChecker\WinPython-64bit\*"; DestDir: "{app}\WinPython-64bit"; Components: main; Flags: ignoreversion recursesubdirs
...
Root: HKCU; Subkey: "Environment"; ValueType:string; ValueName: "RayStationStaticCodeCheckerPython"; \
    ValueData: "{app}\WinPython-64bit\python-2.7.13.amd64\python.exe"; Flags: preservestringtype; Components: main
